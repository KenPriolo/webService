    ...
    >
      ...
      <div className="bg-gray-100 p-8 rounded-md w-full max-w-lg shadow-lg text-gray-800 relative overflow-hidden">
        ...
        <div className="flex justify-around mb-6 bg-gray-200 p-2 rounded z-20 relative">
          <button
            onClick={() => navigate("/admin-login/signup")}
            className={`flex-1 text-center py-2 ${isActive("/admin-login/signup") ? "bg-white text-blue-900 font-semibold" : "hover:bg-white hover:text-blue-900"}`}
          >
            REGISTER
          </button>
          <button
            onClick={() => navigate("/admin-login")}
            className={`flex-1 text-center py-2 ${isActive("/admin-login") ? "bg-white text-blue-900 font-semibold" : "hover:bg-white hover:text-blue-900"}`}
          >
            LOGIN
          </button>
          <button
            onClick={() => navigate("/admin-login/forget-password")}
            className={`flex-1 text-center py-2 ${isActive("/admin-login/forget-password") ? "bg-white text-blue-900 font-semibold" : "hover:bg-white hover:text-blue-900"}`}
          >
            FORGOT PASSWORD
          </button>
        </div>
